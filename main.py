...
pygame.display.set_caption("Space Shooter invadeers")
...
class Player(Ship):
   ...
   def healthbar(self, window):
       ...
       self.x, self.y + self.ship_image.get_height() + 10, self.ship_image.get_width() * (self.health / self.max_health),
       10))
